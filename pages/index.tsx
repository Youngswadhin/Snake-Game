...
export default function SnakeGame() {
  ...
  }, [snake, drawApple, drawSnake, isLost])
    ...
    <>
      ...
      <main>
        ...
        <div className="mobile-controls">
          <button className="control-btn" onClick={handleUpClick}>
            <FontAwesomeIcon icon={['fas', 'arrow-up']} />
          </button>
          ...
          <button className="control-btn" onClick={handleDownClick}>
            <FontAwesomeIcon icon={['fas', 'arrow-down']} />
          </button>
        </div>
      </main>
      <footer>
        Copyright &copy;{' '}
        <a href="https://swadhin-git-folio.vercel.app/">Young Swadhin</a> 2024
        &nbsp;|&nbsp;{' '}
        <a href="https://github.com/Youngswadhin">
