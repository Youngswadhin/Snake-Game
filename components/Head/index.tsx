...
export const HeadComponent = () => (
  <Head>
    <title>Snake | Built by Young Swadhin</title>
    ...
    <meta property="og:title" content="Next-Snake | Built by Young Swadhin" />
    <meta
    ...
    <meta name="twitter:title" content="Next-Snake | Built by Young Swadhin" />
    <meta
